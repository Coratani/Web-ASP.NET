        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner" id="homeCarousel">
                <div class="carousel-item text-center">
                    <img id="92834" src="http://i.annihil.us/u/prod/marvel/i/mg/b/20/62dab302b41ea.jpg"
                         class="d-inline img-fluid" alt="undefined">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" text-light">She-Hulk (2022) #5</h5>
                    </div>
                </div>
                <div class="carousel-item text-center active">
                    <img src="http://i.annihil.us/u/prod/marvel/i/mg/9/10/62b9e0c22e54c.jpg" class="d-inline img-fluid"
                         alt="undefined">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" text-light">She-Hulk (2022) #4</h5>
                    </div>
                </div>
                <div class="carousel-item text-center">
                    <img id="95803" src="http://i.annihil.us/u/prod/marvel/i/mg/c/10/62b9e15eb1b5c.jpg"
                         class="d-inline img-fluid" alt="undefined">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" text-light">Fantastic Four (2018) #44</h5>
                    </div>
                </div>
                <div class="carousel-item text-center">
                    <img id="95802" src="http://i.annihil.us/u/prod/marvel/i/mg/2/f0/627bf79fbebbf.jpg"
                         class="d-inline img-fluid" alt="undefined">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" text-light">Fantastic Four (2018) #43</h5>
                    </div>
                </div>
                <div class="carousel-item text-center">
                    <img id="92832" src="http://i.annihil.us/u/prod/marvel/i/mg/6/50/62432e6fa2d29.jpg"
                         class="d-inline  img-fluid" alt="undefined">
                    <div class="carousel-caption d-none d-md-block">
                        <h5 class=" text-light">She-Hulk (2022) #3</h5>
                    </div>
                </div>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
        <div id="cart" class="d-flex justify-content-start">
            <div class="row">
                <div id="productName" class="col-12 align-self-center"></div>
                <!--            <div id="productPrice" class="col-6 align-content-end"></div>-->
            </div>
        </div>
